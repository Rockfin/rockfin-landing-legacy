...
const Statistic = ({ value, label, prefix = '', suffix = '' }: StatisticProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      className="flex flex-col items-center p-6 bg-white dark:bg-[#080808] border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm"
...
export function GovernmentContractingSection() {
  return (
    <section id="government-contracting" className="py-16 px-4 md:px-6 lg:px-8 bg-white dark:bg-[#080808]">
          ...
          >
            <div className="flex items-center space-x-4 mb-6">
              <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-8 w-8 text-black dark:text-white">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div className="flex flex-col">
                <span className="text-xl font-bold text-black dark:text-white">SAM.gov Registered</span>
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-black dark:text-white">Certifications & Compliance</h3>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {certifications.map((cert, index) => (
                  <li key={index} className="flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-5 w-5 text-black dark:text-white">
